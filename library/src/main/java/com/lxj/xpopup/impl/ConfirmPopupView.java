...
public class ConfirmPopupView extends CenterPopupView implements View.OnClickListener {
    ...
    protected void initPopupContent() {
        ...
        if (!TextUtils.isEmpty(confirmContent)) {
            tv_confirm.setText(confirmContent);
        }

        if (!TextUtils.isEmpty(cancelContent)) {
            tv_cancel.setText(cancelContent);
        }
    ...
    public ConfirmPopupView setConfirmContent(String conent) {
        this.confirmContent = conent;
        return this;
    }

    public ConfirmPopupView setCancelContent(String conent) {
        this.cancelContent = conent;
        return this;
    }
